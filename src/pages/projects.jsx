...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - BOROHOUL Soguelni Malachie</title>
        <meta
          name="description"
        ...
        >
          {projects.map((project) => (
            <Card as="li" key={project.name}>
              ...
              <p className='relative z-10 mt-2 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200'>{project.store.label}</p>
