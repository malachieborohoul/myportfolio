...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>BOROHOUL Soguelni Malachie - Software engineer</title>
        <meta
          name="title"
          content="BOROHOUL Soguelni Malachie - Software engineer "
        />
        <meta
          name="description"
        ...
        <meta
          ...
          content="My name is BOROHOUL Soguelni Malachie, a mobile developer, full stack developer, and software engineer. I am passionate about building software and exploring the world of AI."
        />
        <meta
          property="og:image"
